    ...
    public String retrieveOne(@PathParam("clientId") @ApiParam(value = "clientId") final Long clientId, @Context final UriInfo uriInfo,
        ...
        if (settings.isTemplate()) {
            ...
            clientData = ClientData.builder()
                ...
                .officeOptions(templateData.getOfficeOptions())
                .staffOptions(templateData.getStaffOptions())
                .narrations(templateData.getNarrations())
                .genderOptions(templateData.getGenderOptions())
                .savingProductOptions(templateData.getSavingProductOptions())
                .clientTypeOptions(templateData.getClientTypeOptions())
                .clientClassificationOptions(templateData.getClientClassificationOptions())
                .clientNonPersonConstitutionOptions(templateData.getClientNonPersonConstitutionOptions())
                .clientNonPersonMainBusinessLineOptions(templateData.getClientNonPersonMainBusinessLineOptions())
                .clientLegalFormOptions(templateData.getClientLegalFormOptions())
                .familyMemberOptions(templateData.getFamilyMemberOptions())
                .build();
            ...
            if (savingAccountOptions != null && savingAccountOptions.size() > 0) {
                clientData = ClientData.builder()
                    ...
                    .narrations(clientData.getNarrations())
                    .genderOptions(clientData.getGenderOptions())
                    .timeline(clientData.getTimeline())
                    ...
                    .isAddressEnabled(clientData.getIsAddressEnabled())
                    .isStaff(clientData.getIsStaff())
                    .savingAccountOptions(savingAccountOptions)
                    .build();
            }
        }
