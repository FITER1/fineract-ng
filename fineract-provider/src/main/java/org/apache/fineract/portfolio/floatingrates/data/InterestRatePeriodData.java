...
@AllArgsConstructor
@EqualsAndHashCode
public class InterestRatePeriodData implements Serializable {
	private Date fromDate;
	private BigDecimal interestRate;
	private boolean differentialToBLR;
	private Date blrFromDate;
	private BigDecimal blrInterestRate;
