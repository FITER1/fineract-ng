...
public class LoanRepaymentScheduleTransactionProcessorFactory {
    ...
    private final PrincipalInterestPenaltyFeesOrderLoanRepaymentScheduleTransactionProcessor defaultProcessor;

    public LoanRepaymentScheduleTransactionProcessorFactory(final List<LoanRepaymentScheduleTransactionProcessor> processors, final PrincipalInterestPenaltyFeesOrderLoanRepaymentScheduleTransactionProcessor defaultProcessor) {
    ...
    public LoanRepaymentScheduleTransactionProcessor determineProcessor(final LoanTransactionProcessingStrategy transactionProcessingStrategy) {
        return processors
            .stream()
            .filter(p -> p.accept(transactionProcessingStrategy))
            .findFirst()
