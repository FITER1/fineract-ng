...
public class ProvisioningTransactionHelper {
    ...
    private static final String PROVISIONING_CATEGORY_URL = "/provisioningcategory?" + Utils.TENANT_IDENTIFIER ;
    
    private static final String CREATE_PROVISIONING_CRITERIA_URL = "/provisioningcriteria?" + Utils.TENANT_IDENTIFIER;
    private static final String CREATE_PROVISIONING_ENTRY_URL = "/provisioningentries?" + Utils.TENANT_IDENTIFIER;
    ...
    public Map retrieveProvisioningCriteria(final Integer criteriaId) {
        String url = "/provisioningcriteria/"+criteriaId+"?"+Utils.TENANT_IDENTIFIER ;
    ...
    public Integer updateProvisioningEntry(final String command, final Integer entryId, String jsonBody) {
        String url = "/provisioningentries/" + entryId + "?command=" + command + "&" + Utils.TENANT_IDENTIFIER;
    ...
    public Map retrieveProvisioningEntry(final Integer provisioningEntry) {
        String url = "/provisioningentries/"+provisioningEntry+"?"+Utils.TENANT_IDENTIFIER; ;
        return Utils.performServerGet(requestSpec, responseSpec, url, "") ;
    }
    
    public Map retrieveProvisioningEntries(final Integer provisioningEntry) {
        String url = "/provisioningentries/entries?entryId="+provisioningEntry+"&"+Utils.TENANT_IDENTIFIER; ;
        return Utils.performServerGet(requestSpec, responseSpec, url, "") ;
    }
    
    public Map retrieveAllProvisioningEntries() {
        String url = "/provisioningentries?dateFormat=dd MMMM yyyy"+"&"+"locale=en"+"&"+Utils.TENANT_IDENTIFIER; ;
        return Utils.performServerGet(requestSpec, responseSpec, url, "") ;
    }
